...
class ReseauDAlimentationAdmin(ImportExportModelAdmin, admin.ModelAdmin):
    ...
    list_filter = "date", "I_1_nom_et_prenom", "I_2_sexe", "I_3_telephone", "II_1_province", "II_2_commune", "II_3_zone", "II_4_colline",
...
class IbomboAdmin(ImportExportModelAdmin, admin.ModelAdmin):
    ...
    list_filter = "date", "I_1_nom_et_prenom", "I_2_sexe", "I_3_telephone", "II_1_province", "II_2_commune", "II_3_zone", "II_4_colline", "IV_4_fonctionnel", "IV_5_nb_menages", "IV_6_nb_menages_500",
...
class BranchementPriveAdmin(ImportExportModelAdmin, admin.ModelAdmin):
    ...
    list_filter = "date", "I_1_nom_et_prenom", "I_2_sexe", "I_3_telephone", "II_1_province", "II_2_commune", "II_3_zone", "II_4_colline", "V_4_fonctionnel", "V_6_nb_menages", "V_7_nb_menages_500",
...
class CaptageAdmin(ImportExportModelAdmin, admin.ModelAdmin):
    ...
    list_filter = "date", "I_1_nom_et_prenom", "I_2_sexe", "I_3_telephone", "II_1_province", "II_2_commune", "II_3_zone", "II_4_colline", "VI_4_fonctionnel"
...
class PompeAdmin(ImportExportModelAdmin, admin.ModelAdmin):
    ...
    list_filter = "date", "I_1_nom_et_prenom", "I_2_sexe", "I_3_telephone", "II_1_province", "II_2_commune", "II_3_zone", "II_4_colline", "VII_2_fonctionnel"
...
class PuitAdmin(ImportExportModelAdmin, admin.ModelAdmin):
    ...
    list_filter = "date", "I_1_nom_et_prenom", "I_2_sexe", "I_3_telephone", "II_1_province", "II_2_commune", "II_3_zone", "II_4_colline", "VII_2_fonctionnel", "VII_4_nb_menages", "VII_5_nb_menages_500",
...
class ForageAdmin(ImportExportModelAdmin, admin.ModelAdmin):
    ...
    list_filter = "date", "I_1_nom_et_prenom", "I_2_sexe", "I_3_telephone", "II_1_province", "II_2_commune", "II_3_zone", "II_4_colline", "XIV_3_fonctionnel", "XIV_5_nb_menages", "XIV_6_nb_menages_500",
...
class ReservoirAdmin(ImportExportModelAdmin, admin.ModelAdmin):
    ...
    list_filter = "date", "I_1_nom_et_prenom", "I_2_sexe", "I_3_telephone", "II_1_province", "II_2_commune", "II_3_zone", "II_4_colline", "IX_2_fonctionnel"
...
class SourceAmenageeAdmin(ImportExportModelAdmin, admin.ModelAdmin):
    ...
    list_filter = "date", "I_1_nom_et_prenom", "I_2_sexe", "I_3_telephone", "II_1_province", "II_2_commune", "II_3_zone", "II_4_colline", "X_3_fonctionnel", "X_8_nb_menages", "X_9_nb_menages_500",
...
class SourceNonAmenageeAdmin(ImportExportModelAdmin, admin.ModelAdmin):
    ...
    list_filter = "date", "I_1_nom_et_prenom", "I_2_sexe", "I_3_telephone", "II_1_province", "II_2_commune", "II_3_zone", "II_4_colline", "X_2_fonctionnel"
...
class VillageModerneAdmin(ImportExportModelAdmin, admin.ModelAdmin):
    ...
    list_filter = "date", "I_1_nom_et_prenom", "I_2_sexe", "I_3_telephone", "II_1_province", "II_2_commune", "II_3_zone", "II_4_colline", "XII_2_fonctionnel"
...
class VillageCollinaireAdmin(ImportExportModelAdmin, admin.ModelAdmin):
    ...
    list_filter = "date", "I_1_nom_et_prenom", "I_2_sexe", "I_3_telephone", "II_1_province", "II_2_commune", "II_3_zone", "II_4_colline", "XIII_2_fonctionnel"
